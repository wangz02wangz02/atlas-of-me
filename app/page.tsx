        ...
        <div className="mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[1.1fr_1fr]">
          <div>
            ...
            <p className="mt-6 max-w-xl text-lg leading-relaxed text-bone/80">
              ...
              stitched together with photographs, written reflections, and
              short audio logs. Drag the globe to spin the world. Click any
              glowing marker to step into a memory.
            </p>
          ...
          <div className="relative grid place-items-center">
            <div className="pointer-events-none absolute inset-0 -z-10 rounded-full bg-amber/5 blur-3xl" />
            <Globe places={places} size={520} />
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-5xl">
          <div className="mb-6">
            ...
            <p className="mt-2 max-w-xl text-sm text-bone-dim">
              Drag to pan, scroll to zoom. Filter by continent or year, hover a
              marker for a preview, click to enter. Toggle between flat map and
              spinning globe in the top-right.
            </p>
          </div>
